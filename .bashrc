...
alias shutdown="sudo poweroff -f"
alias quakes="cd ~/.steam/steam/steamapps/common/Quake*Ser*"
alias qrofi="cd ~/.config/rofi/launchers"
alias sbash="source ~/.bashrc"
alias polyconf="vim ~/.config/polybar/config"
alias neofetch="neofetch --source ~/Documents/squirtle.txt"
alias pavu="pavucontrol"
alias picomconf="vim ~/.config/picom/picom.conf"
alias math='~/scripts/math.sh'
alias bruh='fuck'
